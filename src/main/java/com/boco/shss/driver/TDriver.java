...
import cms.impl.GroupShssCmsProtocol;
import com.boco.shss.constant.ConstVarient;
import com.boco.shss.constant.DriverPubConst;
...
import com.boco.shss.tcpcomm.RequestEncoder;
import com.boco.shss.tcpcomm.ResponseDecoder;
import com.boco.shss.constant.DriverConst;
import com.boco.shss.tcpcomm.MsgDealHandler;
import com.boco.shss.model.Request;
import com.boco.shss.model.Response;
...
public class TDriver implements IMessageListener, IPortStatusListener {
    ...
    public boolean sendData(String businessNo, DevVarInfo devVarInfo)
    {
        ...
        switch (sendDriverVarInfo.getDwSendCmd()) {
			case DriverConst.Const_Cmd_PlayLst: //播放表
				...
				GroupShssCmsProtocol CmsProtocol = new GroupShssCmsProtocol();
				...
				break;
			case DriverConst.Const_Cmd_EasyLst: //简易播放表
				Dummy = sendStr;
			...
			case DriverConst.Const_Cmd_ScrOnOff: //开关屏
				...
				ArrSend = Dummy.getBytes("GBK");
				break;
			case DriverConst.Const_Cmd_ReadCms: //读取屏幕点阵信息
				break;
			case DriverConst.Const_Cmd_Bright: //设备屏幕亮度
				...
				break;
			case DriverConst.Const_Cmd_BRMode: //设备屏幕亮度模式
				Dummy = sendStr;
				ArrSend = Dummy.getBytes("GBK");
				break;
	...
	public void onMessageRecv(Object obj) {
		try {
			...
			if ((Cmd == DriverConst.Const_Cmd_PlayLst) || (Cmd == DriverConst.Const_Cmd_EasyLst)
					|| (Cmd == DriverConst.Const_Cmd_ScrOnOff) || (Cmd == DriverConst.Const_Cmd_Bright)
					|| (Cmd == DriverConst.Const_Cmd_BRMode)|| (Cmd == DriverConst.Const_Cmd_Restart))
				{
                if (resp.getDataArray()[0] == DriverConst.Const_Answer_Success)
                {
	...
	public void RabbitmqCtrlCmdback(String businessNo,boolean SendFlag) {
		try {
			...
			Identitytemp.setSourceId("collctrsvr_shss_cms");
